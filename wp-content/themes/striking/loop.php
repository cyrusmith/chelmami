...
<?php if (have_posts()) {
    while (have_posts()) : the_post();
        ...
        <article id="post-<?php the_ID(); ?>" class="entry entry_<?php echo $featured_image_type; ?>">
            ...
            <div class="entry_info">
                <h2 class="entry_title"><a href="<?php echo get_permalink() ?>" rel="bookmark"
                                           title="<?php printf(__("Permanent Link to %s", 'striking_front'), get_the_title()); ?>"><?php the_title(); ?></a>
                </h2>
                ...
                <div class="entry_content">
                    ...
                    if (theme_get_option('blog', 'display_full')):
                        ...
                        <a class="read_more_link"
                           href="<?php the_permalink(); ?>"><?php echo __('Read more &raquo;', 'striking_front')?></a>
                    <?php endif; ?>
                </div>
            </div>
        </article>
    ...
    interoFilter_outputEmpty($wp_query);
}
wp_reset_postdata();
?>